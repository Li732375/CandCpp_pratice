...
int main()
{
	...
	printf("(最右) a_addr_1 字元為\"%c\" ,數值為 %d\n", a_addr_addr_1, a_addr_addr_1);
	printf(" a_addr_2 字元為\"%c\" ,數值為 %d\n", a_addr_addr_2, a_addr_addr_2);
	printf(" a_addr_3 字元為\"%c\" ,數值為 %d\n", a_addr_addr_3, a_addr_addr_3);
	printf("(最左) a_addr_4 字元為\"%c\" ,數值為 %d\n",a_addr_addr_4, a_addr_addr_4);
